    ...
    <div className='bg-gray-800 h-screen w-full grid place-items-center text-white'>
      <Modal isOpen={isModalOpen} closeModal={closeModal}>
        <div className="p-4 flex flex-col">
          ...
          <input type="text" placeholder='paste room id here...' value={joinRoomInput} onChange={handleJoinRoomInput} className='outline-none border-b-2 bg-transparent px-2 py-1' />
          <button onClick={joinRoom} className="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Join Room
          </button>
      ...
      <div className='flex flex-col gap-4 w-96'>
        <button className='px-8 py-4 text-4xl bg-blue-700 rounded' onClick={createRoom}>Create Room</button>
        <button className='px-8 py-4 text-4xl border border-blue-700 rounded' onClick={openModal}>Join Room</button>
        <button className='px-8 py-4 text-4xl border border-blue-700 rounded'>Game Rules</button>
      </div>
    </div>
  )
}
